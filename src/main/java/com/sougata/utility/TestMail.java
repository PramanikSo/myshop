...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "hme.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to HandMadeEasy</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up HandMadeEasy<br>"
					+ "We are glad that you choose <bold>us. We invite you to check out our latest collection of new hand made items."
					...
					+ "<span class='greenText'>HME444</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
