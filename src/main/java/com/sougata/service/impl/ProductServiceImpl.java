package com.sougata.service.impl;
...
import com.sougata.beans.DemandBean;
import com.sougata.beans.ProductBean;
import com.sougata.service.ProductService;
import com.sougata.utility.DBUtil;
import com.sougata.utility.IDUtil;
import com.sougata.utility.MailMessage;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM `myshop`.product where lower(ptype) like ?;");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM `myshop`.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ?");
			search = "%" + search + "%";
